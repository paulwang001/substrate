...
use crate::{group_message::Network, message::validator::{MessageIntent,Validator, ValidatorContext, ValidationResult}};
...
/// Group stream message with sender.
